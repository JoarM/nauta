...
export default function signin() {
    return (
        <div className="grid lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 svh relative bg-primary">
            <Link href="/home" className="absolute left-6 top-3">
                <svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 sm:hidden">
                ...
                <svg width="579" height="128" viewBox="0 0 579 128" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-44 hidden sm:block">
            ...
            <main className="lg:border-l border-t lg:border-t-0 flex items-center justify-center flex-col px-6">
                <h1 className="font-bold text-3xl tracking-tighter">Sign in to Nauta</h1>
                <GithubSignin/>
            </main>
        </div>
    )
